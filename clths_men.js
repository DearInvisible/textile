const clths_men_cntnr = document.querySelector(".clths_men_cntnr");
...
fetch("https://textil.sadaf-med.uz/api/products_by_category", {
  ...
  .then(function (data) {
    ...
    `;
        ...
        clths_men_cntnr.innerHTML = res4.join("");
      } else if (y.matches) {
        clths_men_cntnr.innerHTML = `<div class="d-flex justify-content-center">
